...
const EmployeeDashboard = () => {
  ...
  return (
    ...
    <PageWrapper>
      ...
      {/* Add a container that shifts based on sidebarOpen */}
      ...
      <Modal show={showModal} onHide={handleClose} centered>
        <Modal.Body className="neumorphic-card">
          <h4 className="fw-bold mb-3">Payslip Details</h4>
          <p><strong>Employee:</strong> Sarah Johnson</p>
          <p><strong>Month:</strong> May 2025</p>
          <p><strong>Basic Salary:</strong> $2000</p>
          <p><strong>Allowances:</strong> $300</p>
          <p><strong>Deductions:</strong> $100</p>
          <p><strong>Net Pay:</strong> $2200</p>
          <div className="text-end">
            <Button className="neumorphic-button btn-sm" onClick={handleClose}>
              Close
            </Button>
          </div>
        </Modal.Body>
